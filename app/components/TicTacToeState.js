import { addMove, resetGame } from "../utils/Utils";
...
const getStatusMessage = (cells, player) => {
    if (isTie(cells)) return "Its a tie!!!";

    const winner = getWinner(cells);
    if (winner !== undefined) {
        return "Congratulations player " + winner + ", you win this game!!!";
    } else {
        return "Player " + player + "  your turn";
    }
};
...
const TicTacToeState = connect(mapStateToProps, mapDispatchToProps)(TicTacToe);
